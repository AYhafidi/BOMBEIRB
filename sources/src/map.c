...
{
	switch (type & 0x01)
	{ // le type de porte est coder dans le dernier bit 0:ferme ,1:ouvert
	case DOOR_CLOSED:
...
struct map* map_get_static(void)
{
	...
	unsigned char themap[STATIC_MAP_WIDTH * STATIC_MAP_HEIGHT] = {
	  CELL_BOMB_NB_DEC, CELL_EMPTY, CELL_BOMB_NB_INC, CELL_EMPTY, CELL_EMPTY, CELL_EMPTY, CELL_EMPTY, CELL_EMPTY, CELL_EMPTY, CELL_EMPTY, CELL_EMPTY, CELL_EMPTY,
